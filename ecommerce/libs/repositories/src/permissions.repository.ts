...
import { permissions, Prisma, roles } from 'y/prisma/generated/auth';

@Injectable()
export class PermissionsRepository extends MySQLBaseRepository<permissions, Prisma.permissionsFindManyArgs, Prisma.permissionsFindUniqueArgs> {
