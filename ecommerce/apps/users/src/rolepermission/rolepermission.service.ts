...
import { RolePermissionRepository } from 'y/repositories/rolepermission.repository';

@Injectable()
export class RolepermissionService {
  constructor(private readonly _rolepermissionRepository: RolePermissionRepository) {}
